...
$sql = 'SELECT * FROM gs_bm_table_'.$_SESSION['name'].' where id=:id';
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index_login.php">書籍ブックマーク</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="select.php">お気に入り書籍一覧</a>
                    </li>
                    <li class="nav-item">
